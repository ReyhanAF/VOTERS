<?php
// Version 1.0 - optimized for PHP 5.4
date_default_timezone_set('UTC');
include("settings.inc"); //include file containing general settings
...
function ShowTheStuff($item, $itemvoted, $graph_width, $graph_height) {
	...
	while ($in<$hector) {
		...
		$stepstr=$stepstr.'<img height='.$graph_height.' width='.$timesred.' src="value.gif"><img height='.$graph_height.' width='.($graph_width-$timesred).' src="zero.gif"><br><br>';
		$in++;
	}
	return $stepstr;
}
